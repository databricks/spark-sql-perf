...
class TPCDSTables(
  ...
  dsdgenDir: Option[String] = None,  // If not specified, we use the pre-packaged dsdgen in the JAR
  scaleFactor: String,
  usePartitionedTable: Boolean,
  ...
  val tables = Seq(
    Table("catalog_sales",
      partitionColumns = if (usePartitionedTable) "cs_sold_date_sk" :: Nil else Nil,
      'cs_sold_date_sk          .int,
      'cs_sold_time_sk          .int,
      'cs_ship_date_sk          .int,
    ...
    Table("catalog_returns",
      partitionColumns = if (usePartitionedTable) "cr_returned_date_sk" :: Nil else Nil,
    ...
    Table("inventory",
      partitionColumns = if (usePartitionedTable) "inv_date_sk" :: Nil else Nil,
      'inv_date_sk          .int,
      'inv_item_sk          .int,
      'inv_warehouse_sk     .int,
      'inv_quantity_on_hand .int),
    Table("store_sales",
      partitionColumns = if (usePartitionedTable) "ss_sold_date_sk" :: Nil else Nil,
      'ss_sold_date_sk      .int,
      'ss_sold_time_sk      .int,
      'ss_item_sk           .int,
      'ss_customer_sk       .int,
    ...
    Table("store_returns",
      partitionColumns = if (usePartitionedTable) "sr_returned_date_sk" ::Nil else Nil,
    ...
    Table("web_sales",
      partitionColumns = if (usePartitionedTable) "ws_sold_date_sk" :: Nil else Nil,
      'ws_sold_date_sk          .int,
      'ws_sold_time_sk          .int,
      'ws_ship_date_sk          .int,
      'ws_item_sk               .int,
    ...
    Table("web_returns",
      partitionColumns = if (usePartitionedTable) "wr_returned_date_sk" ::Nil else Nil,
