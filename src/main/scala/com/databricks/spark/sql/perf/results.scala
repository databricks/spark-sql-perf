 ...
 * @param streamingResults The Streaming benchmark results.
 */
case class BenchmarkResult(
    ...
    streamingResults: StreamingBenchmarkResult = null)

/**
 *
 * @param schedulingDelay The scheduling delay results of a Streaming test. The key is something like, avg, min, max,
 *                        25%, 50%...
 * @param processingDelay The processing delay results of a Streaming test. The key is something like, avg, min, max,
 *                        25%, 50%...
 * @param totalDelay The total delay results of a Streaming test. The key is something like, avg, min, max, 25%, 50%
 */
case class StreamingBenchmarkResult(
    schedulingDelay: Map[String, Double],
    processingDelay: Map[String, Double],
    totalDelay: Map[String, Double])
