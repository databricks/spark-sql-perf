...
trait Tpcds_2_4_Queries extends Benchmark {
  ...
  // Queries the TPCDS 2.3 queries using the qualifcations values in the templates.
  val tpcds2_4Queries = Seq(
      ("q1", """
    ...
    Query(name + "-v2.4", sqlText, description = "TPCDS 2.4 Query", executionMode = CollectResults)
  }
